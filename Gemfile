...
gem 'capistrano', '~> 3.8.1', group: :development
gem 'capistrano-rvm', group: :development
gem 'capistrano-rails', group: :development
gem 'capistrano-foreman', '~> 1.2.0', group: :development
...
gem 'foreman', github: 'Pierre-Michard/foreman'
gem 'resque'
gem 'rufus-scheduler'
gem 'resque-scheduler'
gem 'kraken_client', github: 'natonnelier/kraken_client'
gem 'chartkick'
gem 'groupdate'
